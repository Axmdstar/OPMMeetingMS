...
<link href="assets/img/logo.png" rel="icon">
  ...
  <!-- dataTable css  -->
  <!-- https://cdn.datatables.net/2.1.4/css/dataTables.dataTables.css
...
https://cdn.datatables.net/responsive/3.0.2/css/responsive.dataTables.css -->
  ...
  <!-- Sytle For Table Responive -->
   <style>
        ...
        .table {
        min-width: 600px; /* Set a min-width to make sure the table is not squished on small screens */
        }
        }
