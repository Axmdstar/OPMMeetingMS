          ...
          <div class="row">
            ...
            <div class="col-12 col-md-4 mb-4 mr-md-4">
              <div class="card info-card revenue-card">
                <div class="card-body">
                  <h5 class="card-title">Held Meeting</h5>
                  <div class="d-flex align-items-center">
                    <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Badda</td>
                        <td><a href="#" class="text-primary">Villa Reys</a></td>
                        <td>64</td>
                        <td>27/8/2024</td>
                        <td>8:00 AM</td>
                        <td>2:00 PM</td>
            ...
            <div class="card-body">
              ...
              <div class="activity">
                <div class="activity-item d-flex">
                  <div class="activite-label">Nuur</div>
                ...
                <div class="activity-item d-flex">
                  <div class="activite-label">Axmed</div>
